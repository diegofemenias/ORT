...
// PC: Descomposición de un problema: hay tres problemas a resolver 1) eleccion de piezas, 2) jugada, 3) validacion del tablero buscando ganadores
...
// Patrón logico 1 - turnos de jugadores
...
function jugada(id) {
  // Solo se permiten jugadas IF NOT hayGanador
  // PC: Algoritmia 1 - Nombres de variables que ayuden al proceso de resolución del problema
  ...
  if (!hayGanador) {
    ...
    // Luego de cada jugada, verificamos las columnas, 
    // filas y diagonales por un ganador
    ...
    // Nota: TRUE && TRUE && FALSE = FALSE
    // Nota: vacio => FALSE
    // PC: Abstracción: no importa el simbolo de la ficha o boton, da lo mismo cual sea
    // PC:  Reconocimiento de patrones filas. columnas, diagonales
    ...
    // Mencionar que uno no tiene # como string en el parametro
    if (hayGanador == true) {
